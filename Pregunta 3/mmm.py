a = [[3,2,3,4],[1,0,3,2],[1,0,2,0],[4,1,0,2]]
b = [[1,0,1,2],[1,1,0,1],[1,2,2,1],[0,0,1,1]]
...
def split(matrix): # split matrix into quarters #IGUAL QUE NOSOTROS
    a = matrix
    b = matrix
    c = matrix
    d = matrix
...
print (strassen(matriz_1, matriz_2, 8))
# print ("Should be:")
# print (straight(a, b))
# a11, a12, a21, a22 = split(a)
 
#print(split(matriz_1))